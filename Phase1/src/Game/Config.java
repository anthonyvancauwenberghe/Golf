...
public class Config {
    ...
    private static  String texturePath = "Phase1" + File.separator + "src" + File.separator + "textures" + File.separator;
    public static String CourseLocation = "Phase1" + File.separator + "src"+ File.separator +"Courses"+File.separator;
    public static String version ="Phase3";
