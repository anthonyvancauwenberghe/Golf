...
public class StraightLineBot extends AIPlayer {
    ...
    /*public void euclideanDistance() {*/
        ...
        double maxBallSpeed = (2 * Config.getBallRadius() - Config.getHoleRadius()) * Math.sqrt(Config.GROUND_FRICTION / 2 * Config.getHoleRadius());
        ...
        shootBall(1+(vx/Config.GROUND_FRICTION),1+(vy/Config.GROUND_FRICTION),1+(vz/Config.AIR_FRICTION));
        int strokes = 0;
        if (distance > 1.72)
        {
            strokes++;
